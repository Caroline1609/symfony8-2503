...
class Category
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Flower::class, mappedBy: 'id_category', orphanRemoval: true)]
    ...
    public function removeFlower(Flower $flower): static
    {
        if ($this->flowers->removeElement($flower)) {
            ...
            if ($flower->getIdCategory() === $this) {
                $flower->setIdCategory(null);
            }
        }
